...
<head>
    ...
    <title>{{ isset($property) ? 'Edit' : 'Create' }} Property - Hostly Admin</title>
    ...
    <main class="max-w-3xl mx-auto px-6 py-10">
        ...
        >
            ...
            <div class="space-y-6">
                {{-- Host Selection --}}
                <div>
                    <label for="host_id" class="block text-sm font-semibold text-slate-700 mb-2">Host</label>
                    <select name="host_id" id="host_id"
                        ...
                        @foreach($hosts as $host)
                            <option value="{{ $host->id }}" {{ old('host_id', $property->host_id ?? '') == $host->id ? 'selected' : '' }}>
